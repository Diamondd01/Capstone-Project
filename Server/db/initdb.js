...
async function executeUserSQLFile() {
  try {
    ...
    const sqlFilePath = path.join(__dirname, 'user.sql'); // Adjust the path if needed
...
async function executeUserSQLFile() {
    try {
      ...
      // Execute the SQL file using the Sequelize models
  ...
  // Call the function to execute the user.sql file
  executeUserSQLFile();